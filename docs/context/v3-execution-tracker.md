...
| **N-49** | tunnel-to-tunnel depth disagreements | `RampResolver.js` | **OPEN.** What is left after N-47, and a different shape: `239090074(tun)@−2.2 / 239090085(tun)@−18.0` — two underground ways disagreeing about depth, which N-47's rule (street holds, tunnel rises) says nothing about. Also one 24 m survivor at Túnel Glòries where a surface road connects at the tunnel's DEEP end: Case B ramps only ONE end. |
