...
| **time-to-drive** | ledger: **6.94 s** after P4-01 | **19.4 / 20.0 / 21.3 s** over three drives ⚠ **and the poll cap is 130 x 150 ms = 19.5 s.** Suspected to be the timeout, not the load. Instrumented 08-27; next boot says which | +1.5 s | D-61 |
