...
| **R-J2** | **NEW 08-27** — lane paint, sidewalks and kerbs share the guard rail's T-junction blind spot | `roadRenderer.getJunctionPoints` | The fix exists and is one argument (`includeTees`), already used by the rail mask. Turning it on for the other three opens **11,934 new gaps** across the city — correct, but a look change. Do it deliberately and drive it |
